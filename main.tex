...
QCoDeS is a Python-based framework for instrument control and data acquisition in experimental physics, developed by Microsoft's quantum computing consortium \cite{qcodes_website}.
