...
This means the readout structure is not fixed in the software but adapts to each experimental setup, with different devices exposing a different set of signals and readout handlers. Therefore, the structure of read and sub sequences does not need to change between devices, only the configuration.
